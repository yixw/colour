...
__all__ = [
    'ILLUMINANTS_CIE_SDS_DATA', 'ILLUMINANTS_CIE_SDS', 'ILLUMINANTS_SDS'
]

ILLUMINANTS_CIE_SDS_DATA = {
    'A': {
        300: 0.930483,
        305: 1.128210,
        310: 1.357690,
...
ILLUMINANTS_CIE_SDS = CaseInsensitiveMapping({
    'A':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['A'], name='A'),
    'B':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['B'], name='B'),
    'C':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['C'], name='C'),
    'D50':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['D50'], name='D50'),
    'D55':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['D55'], name='D55'),
    'D60':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['D60'], name='D60'),
    'D65':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['D65'], name='D65'),
    'D75':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['D75'], name='D75'),
    'E':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['E'], name='E'),
    'FL1':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['FL1'], name='FL1'),
    'FL2':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['FL2'], name='FL2'),
    'FL3':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['FL3'], name='FL3'),
    'FL4':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['FL4'], name='FL4'),
    'FL5':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['FL5'], name='FL5'),
    'FL6':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['FL6'], name='FL6'),
    'FL7':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['FL7'], name='FL7'),
    'FL8':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['FL8'], name='FL8'),
    'FL9':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['FL9'], name='FL9'),
    'FL10':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['FL10'], name='FL10'),
    'FL11':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['FL11'], name='FL11'),
    'FL12':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['FL12'], name='FL12'),
    'FL3.1':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['FL3.1'], name='FL3.1'),
    'FL3.2':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['FL3.2'], name='FL3.2'),
    'FL3.3':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['FL3.3'], name='FL3.3'),
    'FL3.4':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['FL3.4'], name='FL3.4'),
    'FL3.5':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['FL3.5'], name='FL3.5'),
    'FL3.6':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['FL3.6'], name='FL3.6'),
    'FL3.7':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['FL3.7'], name='FL3.7'),
    'FL3.8':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['FL3.8'], name='FL3.8'),
    'FL3.9':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['FL3.9'], name='FL3.9'),
    'FL3.10':
        SpectralDistribution(
            ILLUMINANTS_CIE_SDS_DATA['FL3.10'], name='FL3.10'),
    'FL3.11':
        SpectralDistribution(
            ILLUMINANTS_CIE_SDS_DATA['FL3.11'], name='FL3.11'),
    'FL3.12':
        SpectralDistribution(
            ILLUMINANTS_CIE_SDS_DATA['FL3.12'], name='FL3.12'),
    'FL3.13':
        SpectralDistribution(
            ILLUMINANTS_CIE_SDS_DATA['FL3.13'], name='FL3.13'),
    'FL3.14':
        SpectralDistribution(
            ILLUMINANTS_CIE_SDS_DATA['FL3.14'], name='FL3.14'),
    'FL3.15':
        SpectralDistribution(
            ILLUMINANTS_CIE_SDS_DATA['FL3.15'], name='FL3.15'),
    'HP1':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['HP1'], name='HP1'),
    'HP2':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['HP2'], name='HP2'),
    'HP3':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['HP3'], name='HP3'),
    'HP4':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['HP4'], name='HP4'),
    'HP5':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['HP5'], name='HP5'),
    'LED-B1':
        SpectralDistribution(
            ILLUMINANTS_CIE_SDS_DATA['LED-B1'], name='LED-B1'),
    'LED-B2':
        SpectralDistribution(
            ILLUMINANTS_CIE_SDS_DATA['LED-B2'], name='LED-B2'),
    'LED-B3':
        SpectralDistribution(
            ILLUMINANTS_CIE_SDS_DATA['LED-B3'], name='LED-B3'),
    'LED-B4':
        SpectralDistribution(
            ILLUMINANTS_CIE_SDS_DATA['LED-B4'], name='LED-B4'),
    'LED-B5':
        SpectralDistribution(
            ILLUMINANTS_CIE_SDS_DATA['LED-B5'], name='LED-B5'),
    'LED-BH1':
        SpectralDistribution(
            ILLUMINANTS_CIE_SDS_DATA['LED-BH1'], name='LED-BH1'),
    'LED-RGB1':
        SpectralDistribution(
            ILLUMINANTS_CIE_SDS_DATA['LED-RGB1'], name='LED-RGB1'),
    'LED-V1':
        SpectralDistribution(
            ILLUMINANTS_CIE_SDS_DATA['LED-V1'], name='LED-V1'),
    'LED-V2':
        SpectralDistribution(
            ILLUMINANTS_CIE_SDS_DATA['LED-V2'], name='LED-V2'),
    'ID65':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['ID65'], name='ID65'),
    'ID50':
        SpectralDistribution(ILLUMINANTS_CIE_SDS_DATA['ID50'], name='ID50'),
})
ILLUMINANTS_CIE_SDS.__doc__ = """
...
ILLUMINANTS_SDS = CaseInsensitiveMapping(ILLUMINANTS_CIE_SDS)
ILLUMINANTS_SDS.__doc__ = """
Aggregated illuminants spectral distributions.
